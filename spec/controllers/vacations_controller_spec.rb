...
RSpec.describe VacationsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all vacations as @vacations" do
      ...
      expect(assigns(:vacations)).to eq([vacation])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested vacation as @vacation" do
      vacation = Vacation.create! valid_attributes
      get :show, params: {id: vacation.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested vacation as @vacation" do
      vacation = Vacation.create! valid_attributes
      get :edit, params: {id: vacation.to_param}, session: valid_session
      expect(assigns(:vacation)).to eq(vacation)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Vacation" do
        expect {
          post :create, params: {vacation: valid_attributes}, session: valid_session
        }.to change(Vacation, :count).by(1)
      end

      it "assigns a newly created vacation as @vacation" do
        post :create, params: {vacation: valid_attributes}, session: valid_session
        expect(assigns(:vacation)).to be_a(Vacation)
        expect(assigns(:vacation)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved vacation as @vacation" do
        post :create, params: {vacation: invalid_attributes}, session: valid_session
        expect(assigns(:vacation)).to be_a_new(Vacation)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested vacation" do
        vacation = Vacation.create! valid_attributes
        put :update, params: {id: vacation.to_param, vacation: new_attributes}, session: valid_session
        vacation.reload
      ...
      it "assigns the requested vacation as @vacation" do
        vacation = Vacation.create! valid_attributes
        put :update, params: {id: vacation.to_param, vacation: valid_attributes}, session: valid_session
        expect(assigns(:vacation)).to eq(vacation)
      end
    ...
    context "with invalid params" do
      it "assigns the vacation as @vacation" do
        vacation = Vacation.create! valid_attributes
        put :update, params: {id: vacation.to_param, vacation: invalid_attributes}, session: valid_session
        expect(assigns(:vacation)).to eq(vacation)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested vacation" do
      vacation = Vacation.create! valid_attributes
      expect {
        delete :destroy, params: {id: vacation.to_param}, session: valid_session
      }.to change(Vacation, :count).by(-1)
    end
